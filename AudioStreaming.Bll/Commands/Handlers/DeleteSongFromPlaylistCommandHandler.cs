...
{
    public class DeleteSongFromPlaylistCommandHandler : IRequestHandler<DeleteSongFromPlaylist, Unit>
    {
        private readonly AudioStreamingDbContext _context;

        public DeleteSongFromPlaylistCommandHandler(AudioStreamingDbContext context)
        {
            _context = context;
        }
